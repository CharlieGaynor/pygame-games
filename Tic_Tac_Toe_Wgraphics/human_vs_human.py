...
def run_game():
    ...
    def generate_buttons(button_positions):
    ...
    buttons = generate_buttons(button_positions)
    ...
    is_filled = [0 for i in range(9)] #0 means empty, 1 means naught, 0 means cross
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if game_state == 0 and not is_draw:
        ...
        if show_play_again:
            play_again_button.draw(screen) #Just for outline
